...
pub fn handle_refresh_time_weighted_shares_reply(
    ...
    for updated_lockup_info in updated_lockups_info.lockups {
        ...
        state::save_vessel_info_snapshot(
            ...
            updated_lockup_info.locked_rounds_remaining,
...
pub fn handle_vote_reply(
    ...
    for vessels_to_harbor in payload.vessels_harbors.clone() {
        ...
        for vessel_info in vessels_info.lockups.iter() {
            ...
            match previous_harbor_id {
                Some(previous_harbor_id) => {
                    if previous_harbor_id != vessels_to_harbor.harbor_id {
                        ...
                        if !payload.user_vote && !vessel_info.time_weighted_shares.is_zero() {
