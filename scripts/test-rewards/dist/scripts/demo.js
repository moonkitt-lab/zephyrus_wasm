...
const test_rewards_integration_1 = require("../src/test-rewards-integration");
...
async function runDemo() {
    ...
    const scenarioFile1 = path_1.default.join(__dirname, "..", "rewards-scenario-1.json");
    const scenarioFile2 = path_1.default.join(__dirname, "..", "rewards-scenario-2.json");
    ...
    console.log(`\n🔄 Running demo with scenario: ${path_1.default.basename(demoScenario)}`);
    console.log("-".repeat(50));
    try {
        const testRunner = new test_rewards_integration_1.TestRewardsIntegration();
