...
export declare class EnvironmentSetup {
    ...
    deployTribute(hydroAddress: string): Promise<string>;
    deploySTTokenInfoProvider(): Promise<number>;
    deployDTokenInfoProvider(): Promise<number>;
    deployHydro(): Promise<string>;
