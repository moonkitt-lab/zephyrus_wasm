...
import type {
  ...
  AdminsResponse,
  ConfigResponse,
  CurrentEpochUserLockedResponse,
  CurrentStageResponse
} from './GatekeeperBase.types'
...
export class GatekeeperBaseClient
  extends GatekeeperBaseQueryClient
  implements GatekeeperBaseInterface
{
