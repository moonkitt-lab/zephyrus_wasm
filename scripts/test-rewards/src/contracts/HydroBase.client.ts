...
import type {
  ...
  AllVotesResponse,
  AllVotesRoundTrancheResponse,
  ApprovalResponse,
  ApprovalsResponse,
  CanLockDenomResponse,
  ConstantsResponse,
  ...
  LockVotesHistoryResponse,
  LockupsSharesResponse,
  NumTokensResponse,
  ProposalResponse,
...
export interface HydroBaseReadOnlyInterface {
  ...
  userVotingPower: ({ address }: { address: string }) => Promise<UserVotingPowerResponse>
  userVotes: ({
    address,
    roundId,
    trancheId
  ...
  canLockDenom: ({ tokenDenom }: { tokenDenom: string }) => Promise<CanLockDenomResponse>
  liquidityDeployment: ({
    proposalId,
    roundId,
    trancheId
  ...
  lockupsShares: ({ lockIds }: { lockIds: number[] }) => Promise<LockupsSharesResponse>
}
export class HydroBaseQueryClient implements HydroBaseReadOnlyInterface {
  ...
  userVotingPower = async ({ address }: { address: string }): Promise<UserVotingPowerResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      user_voting_power: {
        address
      }
  ...
  roundEnd = async ({ roundId }: { roundId: number }): Promise<RoundEndResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      round_end: {
        round_id: roundId
      }
  ...
  canLockDenom = async ({ tokenDenom }: { tokenDenom: string }): Promise<CanLockDenomResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      can_lock_denom: {
  ...
  lockupsShares = async ({ lockIds }: { lockIds: number[] }): Promise<LockupsSharesResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      lockups_shares: {
        lock_ids: lockIds
      }
